...
public class MotionView extends FrameLayout {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        return new MotionViewSavedState(superState, (ArrayList<MotionEntity>) entities);
    }

    @Override
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof MotionViewSavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }
        MotionViewSavedState theState = (MotionViewSavedState) state;
        super.onRestoreInstanceState(theState.getSuperState());
        entities.clear();
        entities.addAll(theState.getEntities());
    }
